...
public class ZombieController : MonoBehaviour {
    ...
    void Update () {
        ...
        if (playerInRange)
        {
            player.GetComponent<FirstPersonCtrll>().m_WalkSpeed = 2.5f;
            player.GetComponent<FirstPersonCtrll>().m_RunSpeed = 5f;

        }
        else
        {
            player.GetComponent<FirstPersonCtrll>().m_WalkSpeed = 5f;
            player.GetComponent<FirstPersonCtrll>().m_RunSpeed = 10f;
        }
