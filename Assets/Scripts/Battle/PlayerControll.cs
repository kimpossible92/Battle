...
public class PlayerControll : MonoBehaviour
{
    ...
    public void HandleUpdate2()
    {
        ...
        {
            transform.position = new Vector3((Input.mousePosition.x * 0.1f) - 40, transform.position.y, transform.position.z);
        }
    }
    ...
    public void HandleUpdate()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Z)) Interac();
    }
    void Interac()
    {
