...
namespace Gameplay.ShipSystems
{
    public class WeaponSystem : MonoBehaviour
    {
        ...
        [SerializeField]
        private List<Weapon2> _weapons;
        [SerializeField] private GameObject goParent;
        bool ll1 = false;
        //public void OnR(InputAction.CallbackContext context) { ll1 = true; }
        //public void OnT(InputAction.CallbackContext context) { ll1 = false; }
        private void Update()
        {
        ...
        public void TriggerLaser()
        {
            if (tag == "Player")
            {
                ...
                if (ll1 == false)
                {
                    _weapons[0].TriggerLaser();
                    _weapons[1].TriggerLaser();
                }
            }
            else if (tag == "bonus") { }
        ...
        {
            _weapons.ForEach(w => w.FirePlayer(_position));
        }
