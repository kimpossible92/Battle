...
public class RaycastWeapon : MonoBehaviour
{
    ...
    List<Bullet2> bullets = new List<Bullet2>();
    ...
    Vector3 GetPosition(Bullet2 bullet)
    {
        //Get Bullet2 position
        //p + ut + 0.5gt^2
    ...
    Bullet2 CreateBullet(Vector3 position, Vector3 velocity)
    {
    ...
    void DestroyBullet()
    {
        if(bullets.Count > 0)
        {
            foreach(Bullet2 bullet in bullets)
            {
    ...
    void RaycastSegment(Vector3 start, Vector3 end, Bullet2 bullet)
    {
