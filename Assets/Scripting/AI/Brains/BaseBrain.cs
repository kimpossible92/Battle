...
namespace CoverShooter
{
    ...
    public class BaseBrain : AIBase
    {
        ...
        /// </summary>
        public Actories ForgottenThreat
        {
        ...
        public void SetSee2(bool see,Actories actories)
        {
            _canSeeTheThreat = see;
            _threat = actories;
        }
        /// <summary>
        ...
        private Actories _threat;
        private Actories _forgottenThreat;
        ...
        /// </summary>
        protected void SetUnseenThreat(bool isHeard, bool isDirect, Actories threat, Vector3 position, Cover threatCover)
        {
        ...
        /// </summary>
        protected void SetThreat(Actories threat, Vector3 position, Cover threatCover)
        {
        ...
        /// </summary>
        protected void SetThreat(bool isVisible, bool isHeard, bool isActual, Actories threat, Vector3 position, Cover threatCover, float time)
        {
