...
namespace CoverShooter
{
    ...
    public class FighterBrain : BaseBrain, IAlertListener, ICharacterHealthListener
    {
        ...
        private HashSet<Actories> _friendsThatCanSeeMe = new HashSet<Actories>();
        private HashSet<Actories> _visibleCivilians = new HashSet<Actories>();
        ...
        private Actories _lockedTarget;

        private bool _isCombatProcess;

        private List<Actories> _visibleActors = new List<Actories>();
        ...
        /// </summary>
        public void ToAttack(Actories target)
        {
        ...
        /// </summary>
        public void OnSeeDeath(Actories actor)
        {
        ...
        /// </summary>
        public void OnSpawn(Actories caller)
        {
        ...
        public void OnHit(Hit hit)
        {
            ...
            {
                var threat = hit.Attacker.GetComponent<Actories>();
        ...
        /// </summary>
        public void OnFriendHit(Actories friend)
        {
        ...
        /// </summary>
        public void OnFoundFriend(Actories friend)
        {
            var brain = friend.GetComponent<FighterBrain>();
        ...
        /// </summary>
        public void OnLostFriend(Actories friend)
        {
        ...
        /// </summary>
        public void OnCivilianAlerted(Actories actor)
        {
            if (Threat == null || !Threat.IsAlive)
            {
                if (!canSetThreat)
        ...
        /// </summary>
        public void OnFriendKnowsEnemy(Actories friend)
        {
        ...
        /// Notified by a friend that they found a new enemy position.
        /// </summary>
        public void OnFriendFoundEnemy(Actories friend)
        {
            if (friend == null || friend.Side != Actor.Side)
                return;
        ...
        /// </summary>
        public void OnSeenByFriend(Actories friend)
        {
        ...
        /// </summary>
        public void OnUnseenByFriend(Actories friend)
        {
            if (_friendsThatCanSeeMe.Contains(friend))
        ...
        /// </summary>
        public void OnSeeActor(Actories actor)
        {
        ...
        /// </summary>
        public void OnUnseeActor(Actories actor)
        {
            _visibleActors.Remove(actor);
        ...
        protected override void Awake()
        {
            ...
            switch (Start.Mode)
            {
                ...
                case AIStartMode.investigate:
                    ...
                    break;
                case AIStartMode.findcustom:
                    _futureSetState = FighterState.avoidAndFight;
                    break;
            }
        }
        ...
        private void Update()
        {
            ...
            switch (_state)
            {
                ...
                case FighterState.avoidAndFight:
                    turnAndAimAtTheThreat();
                    #region FPSPlayer
                    LayerMask _layer = LayerMask.GetMask("FPSGun"); //RaycastHit hit;
                    LayerMask _layer2 = LayerMask.GetMask("Impact"); //RaycastHit _hitImpact;
                    float dist1 = 0;
                    float dist2 = 0;
                    //if (GetComponent<AISight>()._actoriesSee == null) { break; }
                    var see1 = GameObject.FindGameObjectWithTag("Player").GetComponent<ICh>().isfoot;
                    var direction2 = (GetComponent<AISight>()._actoriesSee.transform.position - transform.position);
                    bool see2 = false;
                    if (MMDebug.Raycast3DBoolean(transform.position, direction2, 20f, _layer2, Color.cyan)
                    //.collider.TryGetComponent<HitEffect>(out var hitEffect1)
                    )
                    {
                        //dist2 = Vector3.Distance(transform.position, hitEffect1.transform.position);
                        see2 = true;
                        SetSee2(true, GetComponent<AISight>()._actoriesSee);
                    }
                    if (MMDebug.Raycast3DBoolean(transform.position, direction2, 20f, _layer, Color.cyan))
                    {
                        dist1 = Vector3.Distance(transform.position, GetComponent<AISight>()._actoriesSee.transform.position);
                        SetSee2(true, GetComponent<AISight>()._actoriesSee);
                    }
                    if (see2)
                    {
        ...
        private void guessThreat(Actories threat, Vector3 position, bool isHeard)
        {
        ...
        private void setUnseenThreat(bool isHeard, bool isDirect, bool isSeenByFriend, Actories threat, Vector3 position, Cover threatCover)
        {
            setThreat(false, isHeard, isSeenByFriend, isDirect, threat, position, threatCover, Time.timeSinceLevelLoad);
        }

        private void setSeenThreat(Actories threat, Vector3 position, Cover threatCover)
        {
            setThreat(true, false, false, true, threat, position, threatCover, Time.timeSinceLevelLoad);
        }

        private void setThreat(bool isVisible, bool isHeard, bool isVisibleByFriends, bool isActual, Actories threat, Vector3 position, Cover threatCover, float time)
        {
