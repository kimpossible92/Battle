...
namespace CoverShooter
{
    ...
    public struct GeneratedAlert
    {
        ...
        public GeneratedAlert(Vector3 position, float range, bool isHostile, Actories actor, bool isDirect)
        {
            Position = position;
            Range = range;
            IsHostile = isHostile;
    ...
    public static class Alerts
    {
        ...
        /// </summary>
        public static void Broadcast(Vector3 position, float range, bool isHostile, Actories actor, bool isDirect)
        {
