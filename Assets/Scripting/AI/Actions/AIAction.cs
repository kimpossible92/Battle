...
namespace CoverShooter
{
    ...
    public abstract class AIAction : ScriptableObject
    {
        ...
        protected Actories _actor;
        protected Actories _targetActor;
        ...
        /// </summary>
        public void SetupActor(Actories actor)
        {
            _actor = actor;
        }
        ...
        /// </summary>
        public bool Execute(Actories actor)
        {
            _actor = actor;
            _targetActor = null;
        ...
        /// </summary>
        public bool Execute(Actories actor, Vector3 position)
        {
            _actor = actor;
            _targetActor = null;
        ...
        /// </summary>
        public bool Execute(Actories actor, Actories target)
        {
            _actor = actor;
            _targetActor = target;
        ...
        /// </summary>
        public virtual bool IsNeededFor(Actories target)
        {
            return false;
        }
        ...
        /// </summary>
        public virtual bool WillMoveForActor(Actories target)
        {
            return false;
        }
