...
namespace CoverShooter
{
    ...
    public class AIActions : AIBase
    {
        ...
        private List<Actories> _possibleActionTargets = new List<Actories>();
        private List<Actories> _nearbyActors = new List<Actories>();
        ...
        /// </summary>
        public void Execute(AIAction action, Actories target)
        {
            if (_active != null || action.Wait > float.Epsilon)
                return;
        ...
        private void Update()
        {
                ...
                (!WaitForCoverActions || !_isTakingCover))
            {
                ...
                Actories bestSingleActionTarget = null;
