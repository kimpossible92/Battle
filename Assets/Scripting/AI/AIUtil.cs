...
namespace CoverShooter
{
    ...
    public static class AIUtil
    {
        ...
        /// </summary>
        public static Actories[] Actors = new Actories[128];
        ...
        /// </summary>
        public static int FindActorsIncludingDead(Vector3 position, float radius, Actories ignore = null)
        {
        ...
        /// </summary>
        public static int FindActors(Vector3 position, float radius, Actories ignore = null)
        {
        ...
        /// Finds all actors near the given position in a given radius. Returns number of them and fills the Actors array with the results.
        /// </summary>
        public static int FindActors(Vector3 position, float radius, bool ignoreDead, Actories ignore = null)
        {
            int count = 0;
        ...
        /// </summary>
        public static Actories FindClosestActorIncludingDead(Vector3 position, float radius, Actories ignore = null)
        {
        ...
        /// </summary>
        public static Actories FindClosestActor(Vector3 position, float radius, Actories ignore = null)
        {
        ...
        /// Finds a closest actor to the given position in a given radius.
        /// </summary>
        public static Actories FindClosestActor(Vector3 position, float radius, bool ignoreDead, Actories ignore = null)
        {
            Actories result = null;
            float minDist = 0;
            ...
            for (int i = 0; i < physicsCount; i++)
            {
                ...
                var actor = _colliders[i].GetComponent<Actories>();
        ...
        /// </summary>
        public static bool IsInSight(Actories actor, Vector3 target, float maxDistance, float fieldOfView, float obstacleObstructionDistance = 1)
        {
        ...
        /// </summary>
        public static bool IsCoverPositionFree(Cover cover, Vector3 position, float threshold, Actories newcomer)
        {
        ...
        /// </summary>
        public static bool IsJustThisCoverPositionFree(Cover cover, Vector3 position, float threshold, Actories newcomer)
        {
