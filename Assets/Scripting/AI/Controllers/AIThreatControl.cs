...
namespace CoverShooter
{
    ...
    public class AIThreatControl : AIBase
    {
        ...
        private Actories _previous;
        private Vector3 _previousThreatPosition;
        private Actories _reference;
        ...
        private Actories _threatOverride;
        ...
        /// </summary>
        public void ToSetThreatReference(Actories reference)
        {
        ...
        /// </summary>
        public void ToOverrideThreat(Actories threat)
        {
        ...
        private void removeFromMemory(Actories actor)
        {
            for (int i = 0; i < _memory.Count; i++)
        ...
        private void addToMemory(Actories actor, Vector3 position)
        {
