...
namespace CoverShooter
{
    ...
    public class AICommunication : AIBase
    {
        ...
        /// </summary>
        public IEnumerable<Actories> Friends
        {
            get { return _friends; }
        }
        ...
        private HashSet<Actories> _stayFriends = new HashSet<Actories>();
        private HashSet<Actories> _friends = new HashSet<Actories>();
        private HashSet<Actories> _oldFriends = new HashSet<Actories>();

        private float _wait = 0;

        private static Dictionary<Actories, AICommunication> _components = new Dictionary<Actories, AICommunication>();
        ...
        private AICommunication get(Actories actor)
        {
