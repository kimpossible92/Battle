...
namespace CoverShooter
{
    ...
    public class SpawnPicker : MonoBehaviour
    {
        ...
        /// </summary>
        public void SpawnSpecific(SpawnGroup group, Actories caller, bool isForced = false)
        {
            if (group == null)
                return;
        ...
        /// </summary>
        public IEnumerable<GameObject> SpawnAndReturn(SpawnGroup group, Actories caller, bool isForced = false)
        {
