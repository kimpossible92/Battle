...
namespace CoverShooter
{
    ...
    public class SpawnGroup : MonoBehaviour
    {
        ...
        /// </summary>
        public void Spawn(Actories caller)
        {
        ...
        /// </summary>
        public IEnumerable<GameObject> SpawnAndReturn(int max, Actories caller, bool isForced = false)
        {
        ...
        /// </summary>
        public IEnumerable<GameObject> SpawnAndReturn(int max, GameObject[] prefabs, Actories caller, bool isForced = false)
        {
            if (Secondary != null && Random.Range(0f, 1f) <= SecondaryChance)
            {
