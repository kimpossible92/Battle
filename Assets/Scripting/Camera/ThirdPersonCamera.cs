...
namespace CoverShooter
{
    ...
    public class ThirdPersonCamera : BaseCamera
    {
        ...
        private ThirdPersonControllies _controller;
        ...
        /// </summary>
        private ThirdPersonControllies getCurrentController()
        {
            if (_cachedMotor != Target)
            {
                ...
                if (_cachedMotor == null)
                    ...
                    _controller = _cachedMotor.GetComponent<ThirdPersonControllies>();
            }
        ...
        public void UpdatePosition()
        {
            ...
            var controller = Target.GetComponent<ThirdPersonControllies>();
