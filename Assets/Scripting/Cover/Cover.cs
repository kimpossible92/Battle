...
namespace CoverShooter
{
    ...
    public class Cover : MonoBehaviour
    {
        ...
        private Dictionary<Actories, CoverUser> _userMap = new Dictionary<Actories, CoverUser>();
        ...
        /// </summary>
        public void RegisterUser(Actories actor, Vector3 position)
        {
            CoverUser user;
            user.Actor = actor;
        ...
        /// </summary>
        public void UnregisterUser(Actories actor)
        {
